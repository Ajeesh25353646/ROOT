...
void gaussian_pdf() {
    ...
    // Change the value of sigma and plot again with a different color
    sigma.setVal(4);
    ...
    xframe->Draw();
    canvas1->Update(); // Make sure the canvas is updated to show the plot
    ...
    gauss.plotOn(xframe2, LineColor(kBlue)); // Plot the fitted function
    xframe2->Draw();
    canvas2->Update();
}
